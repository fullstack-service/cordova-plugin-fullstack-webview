...
[![npm](https://img.shields.io/npm/v/cordova-plugin-fullstack-webview.svg)](https://www.npmjs.com/package/cordova-plugin-fullstack-webview)

# Fullstack Service Web View for Cordova
...
Note: This repo and its documentation are for `cordova-plugin-fullstack-webview` @ `4.x`, which uses the new features that may not work with all apps. See [Requirements](#plugin-requirements) and [Migrating to 4.x](#migrating-to-4x).

2.x documentation can be found [here](https://github.com/fullstack-service/cordova-plugin-fullstack-webview/blob/2.x/README.md).
...
:sparkling_heart: **Want to contribute?** Please see [CONTRIBUTING.md](https://github.com/fullstack-service/cordova-plugin-fullstack-webview/blob/master/CONTRIBUTING.md).
...
1. Remove and re-add the Web View plugin:
    ...
    ```
    cordova plugin rm 
    cordova plugin add cordova-plugin-fullstack-webview@latest
    ```
